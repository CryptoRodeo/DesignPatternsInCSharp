using System;
using decorator_pattern.concerete_component;
using decorator_pattern.concerete_decorators;
namespace decorator_pattern
{
    //This is essentially the client code that works with all the objects using the Component Interface
    class Program
    {
